    ...
    <div id='faq'>\
      ...
      <section class='someSection'>\
        ...
        <div class='question'>\
          ...
          <a name='groupBy'></a>\
          <p>\
            Campaign finance data is messy. Some contributions come from individuals. Others come from companies, unions or other advocacy groups. And there are lots of ways to describe the same thing. For example, 'IBM' can also be called 'International Business Machines'. We did our best to group businesses together, but it\'s tricky and not perfect. You can check out our rules on github.\
          </p>\
        </div>\
        <div class='question'>\
          <h3>How is this data presented?</h3>\
          <p>\
            The data is presented as reported by the candidate-controlled committee.  Open Disclosure does not clean, scrub, or edit the data.  If there are misspellings or duplicate entries then that was how the committee reported the campaign finance data.\
          </p>\
        </div>\
        <div class = 'question'>\
